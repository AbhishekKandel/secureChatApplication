...
import com.mianasad.chatsapp.Activities.AES;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Date date = new Date();
                // use AESEncryption method below
                Message message = new Message(AESEncryptionMethod(messageTxt), senderUid, date.getTime());
                ...
                lastMsgObj.put("lastMsg", message.getMessage1());
